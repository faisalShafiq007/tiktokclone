...
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlBilateralFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlBoxBlurFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlBrightnessFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlBulgeDistortionFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlCGAColorspaceFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlContrastFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlCrosshatchFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlExposureFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlFilterGroup;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlGammaFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlGaussianBlurFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlGrayScaleFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlHalftoneFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlHazeFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlHighlightShadowFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlHueFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlInvertFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlLookUpTableFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlLuminanceFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlLuminanceThresholdFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlMonochromeFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlOpacityFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlPixelationFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlPosterizeFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlRGBFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlSaturationFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlSepiaFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlSharpenFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlSolarizeFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlSphereRefractionFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlSwirlFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlToneCurveFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlToneFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlVibranceFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlVignetteFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlWatermarkFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlWeakPixelInclusionFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlWhiteBalanceFilter;
import com.daasuu.Tiktokvideo.Tiktok.egl.filter.GlZoomBlurFilter;
import com.daasuu.Tiktokvideo.filter.GlBitmapOverlaySample;
...
public enum FilterType {
    ...
    public static GlFilter createWatermark( Context context) {
        return new GlWatermarkFilter(BitmapFactory.decodeResource(context.getResources(), R.drawable.resizelogo), GlWatermarkFilter.Position.RIGHT_BOTTOM);
    }


    public static GlFilter createGlFilter(FilterType filterType, Context context) {
        new GlWatermarkFilter(BitmapFactory.decodeResource(context.getResources(),
                R.drawable.resizelogo), GlWatermarkFilter.Position.RIGHT_BOTTOM);
        switch (filterType) {
            case DEFAULT:
                return new GlWatermarkFilter(BitmapFactory.decodeResource(context.getResources(),
                        R.drawable.resizelogo), GlWatermarkFilter.Position.RIGHT_BOTTOM);
            ...
            case BITMAP_OVERLAY_SAMPLE:
                return new GlBitmapOverlaySample(BitmapFactory.decodeResource(context.getResources(), R.drawable.resizelogo));
            default:
                return new GlWatermarkFilter(BitmapFactory.decodeResource(context.getResources(), R.drawable.resizelogo), GlWatermarkFilter.Position.RIGHT_BOTTOM);

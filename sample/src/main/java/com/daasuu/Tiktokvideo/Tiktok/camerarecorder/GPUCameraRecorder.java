...
import com.daasuu.Tiktokvideo.FilterType;
import com.daasuu.Tiktokvideo.Tiktok.camerarecorder.capture.MediaAudioEncoder;
import com.daasuu.Tiktokvideo.Tiktok.camerarecorder.capture.MediaEncoder;
import com.daasuu.Tiktokvideo.Tiktok.camerarecorder.capture.MediaMuxerCaptureWrapper;
import com.daasuu.Tiktokvideo.Tiktok.camerarecorder.capture.MediaVideoEncoder;
import com.daasuu.Tiktokvideo.Tiktok.egl.GlPreviewRenderer;
        ...
        if (cameraHandler == null) {
            final CameraThread thread = new CameraThread(cameraRecordListener, new CameraThread.OnStartPreviewListener() {
                ...
                public void onStart(Size previewSize, boolean flash) {
                    ...
                    float finalPreviewWidth = previewWidth;
                    float finalPreviewHeight = previewHeight;
                    glSurfaceView.post(new Runnable() {
                        @Override
                        public void run() {
                            if (glPreviewRenderer != null) {
                                glPreviewRenderer.setAngle(degrees);
                                glPreviewRenderer.onStartPreview(finalPreviewWidth, finalPreviewHeight, isLandscapeDevice);
                            }
                        }
                    });
